...
func Test_export_counters(t *testing.T) {
	...
	for _, re := range []*regexp.Regexp{
		...
		regexp.MustCompile("chronos_bar_count 2"),
	} {
		if !re.Match(results) {
...
func Test_export_gauges(t *testing.T) {
	...
	//t.Log(string(results))
	for _, re := range []*regexp.Regexp{
		regexp.MustCompile("chronos_foo_value 1"),
		regexp.MustCompile("chronos_bar_value 2"),
	} {
		if !re.Match(results) {
...
func Test_export_meters(t *testing.T) {
	...
	//t.Log(string(results))
	for _, re := range []*regexp.Regexp{
		regexp.MustCompile("chronos_foo_meter_count 1"),
		regexp.MustCompile("chronos_foo_meter{rate=\"(1m|5m|15m|mean)\"} 1"),
		regexp.MustCompile("chronos_bar_meter_count 2"),
		regexp.MustCompile("chronos_bar_meter{rate=\"(1m|5m|15m|mean)\"} 2"),
	} {
		if !re.Match(results) {
...
func Test_export_histograms(t *testing.T) {
	...
	//t.Log(string(results))
	for _, re := range []*regexp.Regexp{
		regexp.MustCompile("chronos_foo_histogram_count 1"),
		regexp.MustCompile("chronos_foo_histogram_max 1"),
		regexp.MustCompile("chronos_foo_histogram_min 1"),
		...
		regexp.MustCompile("chronos_bar_histogram_count 2"),
		regexp.MustCompile("chronos_bar_histogram_max 2"),
		regexp.MustCompile("chronos_bar_histogram_min 2"),
		regexp.MustCompile("chronos_bar_histogram_mean 2"),
		regexp.MustCompile("chronos_bar_histogram_stddev 2"),
		regexp.MustCompile("chronos_bar_histogram{percentile=\"0\\.\\d+\"} 2"),
	} {
		if !re.Match(results) {
...
func Test_export_timers(t *testing.T) {
	...
	//t.Log(string(results))
	for _, re := range []*regexp.Regexp{
		regexp.MustCompile("chronos_foo_timer_count 1"),
		regexp.MustCompile("chronos_foo_timer_max 1"),
		regexp.MustCompile("chronos_foo_timer_min 1"),
		regexp.MustCompile("chronos_foo_timer_mean 1"),
		regexp.MustCompile("chronos_foo_timer_stddev 1"),
		regexp.MustCompile("chronos_foo_timer{percentile=\"0\\.\\d+\"} 1"),
		regexp.MustCompile("chronos_foo_timer_rate{rate=\"(1m|5m|15m|mean)\"} 1"),
		regexp.MustCompile("chronos_bar_timer_count 2"),
		regexp.MustCompile("chronos_bar_timer_max 2"),
		regexp.MustCompile("chronos_bar_timer_min 2"),
		regexp.MustCompile("chronos_bar_timer_mean 2"),
		regexp.MustCompile("chronos_bar_timer_stddev 2"),
		regexp.MustCompile("chronos_bar_timer{percentile=\"0\\.\\d+\"} 2"),
		regexp.MustCompile("chronos_bar_timer_rate{rate=\"(1m|5m|15m|mean)\"} 2"),
	} {
		if !re.Match(results) {
